        ...
        <div className="my-auto items-center justify-center flex flex-col gap-y-5 rounded-lg bg-white p-16 border-2 border-[#d43d3d]">
            <ul className='flex flex-col items-center justify-center font-bold text-black gap-y-5 w-full text-center'>
                <li className='border p-2'>
                    En İyi Müşteri: <span className='font-normal'>{this.state.user.first_name}</span>
                </li>
                <li className='border p-2'>
                    En Az İlgili Müşteri: <span className='font-normal'>{this.state.user.first_name}</span>
                </li>
                <li className='border p-2'>
                    En Fazla Loyalt Bakiyesine Sahip Müşteri: <span className='font-normal'>{this.state.user.first_name}</span>
                </li>
                <li className='border p-2'>
                    En Çok Satılan Ürün: <span className='font-normal'>{this.state.user.first_name}</span>
                </li>
                <li className='border p-2'>
                    En Fazla Sipariş Veren Cinsiyet: <span className='font-normal'>{this.state.user.first_name}</span>
                </li>
            </ul>
        </div>
